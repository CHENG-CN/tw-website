...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Incidencia::create([
            ...
            'ubicacion' => 'C/ Ronda n100 | 37.172656, -3.607637',
            'estado' => 'pendiente', 
        ...
        Incidencia::create([
            ...
            'ubicacion' => 'Plaza Einstein |37.1778046,-3.6099937',
            'estado' => 'en_proceso',
        ...
        Incidencia::create([
            ...
            'ubicacion' => 'C/ Ronda n10 | 37.164109, -3.602060',
            'estado' => 'solucionado',
        ...
        Incidencia::create([
            ...
            'ubicacion' => 'Avenida del sur 11 | 37.187519, -3.612362',
            'estado'    => 'sin_validar',
            'foto' => 'storage/incidencias/baches.jpeg',
